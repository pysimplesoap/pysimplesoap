...
def adder(p, c, dt=None):
    ...
    return OrderedDict([('ab', p['a'] + p['b']), ('dd', c[0]['d'] + c[1]['d']), ('dt', dt)])
...
class TestSoapDispatcher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dispatcher.register_function('Adder', adder,
            returns=OrderedDict([('ab', int), ('dd', str), ('dt', datetime.datetime)]),
    ...
    def test_classic_dialect(self):
        ...
        resp = b"""<?xml version="1.0" encoding="UTF-8"?><soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><soap:Body><AdderResponse xmlns="http://example.com/pysimplesoapsamle/"><ab>3</ab><dd>5000000.3</dd><dt>2011-07-24</dt></AdderResponse></soap:Body></soap:Envelope>"""
    ...
    def test_modern_dialect(self):
        ...
        resp = b"""<?xml version="1.0" encoding="UTF-8"?><soapenv:Envelope xmlns:pys="http://example.com/pysimplesoapsamle/" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><soapenv:Body><AdderResponse xmlns="http://example.com/pysimplesoapsamle/"><ab>12</ab><dd>15.021</dd><dt>1970-07-20</dt></AdderResponse></soapenv:Body></soapenv:Envelope>"""
        xml = """
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:pys="http://example.com/pysimplesoapsamle/">
   ...
   <soapenv:Body>
    ...
    def test_echo(self):
        ...
        resp = b"""<?xml version="1.0" encoding="UTF-8"?><soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><soap:Body><EchoResponse xmlns="http://example.com/pysimplesoapsamle/"><value xsi:type="xsd:string">Hello world</value></EchoResponse></soap:Body></soap:Envelope>"""
        xml = """<?xml version="1.0" encoding="UTF-8"?>
    <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"
