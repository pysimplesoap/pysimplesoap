...
Python simple and lightweight SOAP library for client and server webservices interfaces, aim to be as small and easy as possible, supporting most common functionality.
